...
export const mainHandComponents: IMechComponent[] = [
{
    ...
    name: '“Impact” Railgun',
    description: 'Make an attack roll (1d8). On a hit, deal 2 damage and 1 break. Deal 1 damage to any creature within 10 feet in a line behind the creature you hit.',
}, {
    name: '“Omen” Coil gun',
    ...
    description: 'Make an attack roll (1d6). On a hit, deal 2 damage. Deal an additional 2 damage to every creature within 30 feet of the target.'
}];